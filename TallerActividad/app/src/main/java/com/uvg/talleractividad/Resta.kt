...
import kotlinx.android.synthetic.main.resta.*
...
class Resta : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegresarresta.setOnClickListener{
            var numero1:Double = 0.0
            var numero2:Double = 0.0

            val valor1:EditText = findViewById(R.id.valorresta1)
            val valor2:EditText = findViewById(R.id.valorresta2)
