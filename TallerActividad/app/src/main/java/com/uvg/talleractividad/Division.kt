...
import kotlinx.android.synthetic.main.division.*
...
class Division : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegresardiv.setOnClickListener{
            var numero1:Double = 0.0
            var numero2:Double = 0.0

            val valor1: EditText = findViewById(R.id.valordiv1)
            val valor2: EditText = findViewById(R.id.valordiv2)
