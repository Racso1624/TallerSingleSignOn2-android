...
import kotlinx.android.synthetic.main.multiplicacion.*
...
class Multiplicacion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegresarmulti.setOnClickListener{
            var numero1:Double = 0.0
            var numero2:Double = 0.0

            val valor1: EditText = findViewById(R.id.valormulti1)
            val valor2: EditText = findViewById(R.id.valormulti2)
